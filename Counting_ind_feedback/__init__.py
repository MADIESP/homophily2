...
doc = """
Counting Task: No Communication and feedback. But can't submit a new answer. 
"""

class C(BaseConstants):
    NAME_IN_URL = 'Counting_ind_feedback'
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 6
    TIME_PER_PROBLEM = 45
...
class feedback(Page):
        ...
        def is_displayed(player):
            return player.correct == True and  get_timeout_seconds(player) > 3
...
page_sequence = [Start,Count, Confidence,feedback, feedback_neg]