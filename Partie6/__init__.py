...
class Player(BasePlayer):
    ...
    points_beliefs4=models.IntegerField()
    ...
    test_Belief2 = models.IntegerField(
        widget=widgets.RadioSelectHorizontal,
        choices=[[0,'Ils ont été classés aléatoirement. '], [1,'Ils ont été classés en fonction du nombre de tableaux qu’ils ont correctement compté dans l’ensemble de l’expérience. '], [2,'Ils ont été classés en fonction du nombre de tableaux que leur équipe a correctement compté dans les 3 parties de jeu collectif.']],initial=1)
    test_Belief3 = models.IntegerField(
        widget=widgets.RadioSelect,
        choices=[[0, "Je gagnerais un point supplémentaire par rang correct."], [1, "Je n'obtiendrais aucun point supplémentaire."]], initial=0)
    test_Belief4 = models.IntegerField(
        widget=widgets.RadioSelect,
        choices=[[0, "Je n'obtiendrais aucun point supplémentaire."], [1, "Je peux obtenir jusqu'à quatre points supplémentaires."]], initial=1)
...
class Compréhension_Belief_Gender_Error(Page):
    ...
    def is_displayed(player: Player):
        return player.test_Belief1 != 1 or player.test_Belief2 != 1 or player.test_Belief3 != 0 or player.test_Belief4 != 1
...
class Ranking_genderAB(Page):
    ...
    def is_displayed(player: Player):
        ...
        return participant.InGroupA == True or participant.InGroupB == True
...
class Ranking_genderCD(Page):
    ...
    def is_displayed(player: Player):
        participant = player.participant
        return participant.InGroupC == True or participant.InGroupD == True
