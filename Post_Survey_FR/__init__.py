...
class Player(BasePlayer):
    test_Belief1 = models.IntegerField(
        ...
        choices=[[0, 'Des personnes fictives.'] ,[1,'	Des personnes ayant participé à une session antérieure de l’expérience, et ayant reçu les mêmes instructions que moi.']],initial=1)
    test_Belief2 = models.IntegerField(
        widget=widgets.RadioSelectHorizontal,
        choices=[[0,'Ils ont été classés aléatoirement. '],[1,'Ils ont été classés en fonction du nombre de tableaux qu’ils ont correctement compté dans une partie de l’expérience qui a été sélectionnée aléatoirement.'], [2,'Ils ont été classés en fonction du nombre de tableaux qu’ils ont correctement compté dans l’ensemble de l’expérience. '], [3,'Ils ont été classés en fonction du nombre de tableaux que leur équipe a correctement compté dans une partie qui a été sélectionnée au hasard.'], [4,'Ils ont été classés en fonction du nombre de tableaux que leur équipe a correctement compté dans les 3 parties de jeu collectif.']],initial=2)
    test_Belief3 = models.IntegerField(
        widget=widgets.RadioSelect,
        choices=[[0, "Je gagnerais un point supplémentaire."], [1, "Je n'obtiendrais aucun point supplémentaire."]], initial=0)
    test_Belief4 = models.IntegerField(
        widget=widgets.RadioSelect,
        choices=[[0, "Je gagnerais un point supplémentaire."], [1, "Je n'obtiendrais aucun point supplémentaire."]], initial=1)
    test_Belief5 = models.IntegerField(
        widget=widgets.RadioSelect,
        choices=[[0, "Je n'obtiendrais aucun point supplémentaire."], [1, "Je peux obtenir jusqu'à un point supplémentaire."],[2, "Je peux obtenir jusqu'à quatre points supplémentaires."]], initial=2)
    ...
    SPSRQ_q18 = models.IntegerField(
        ...
        # widget=widgets.Select,
        verbose_name='18. Vous abstenez-vous souvent de faire quelque chose que vous aimez pour ne pas être réprimandé(e) ou désapprouvé(e) par les autres ? ',
        widget=widgets.RadioSelectHorizontal,
        initial=1,
    ...
    questionnaire_q3 = models.IntegerField(
        ...
        choices=[[0, 'Etudiant/Etudiante en L1'], [1, 'Etudiant/Etudiante en L2'], [2, 'Etudiant/Etudiante en L3'], [3, 'Etudiant/Etudiante en M1'], [4, 'Etudiant/Etudiante en M2'],
                 [5, 'Doctorant/Doctorante'], [6, 'En recherche d’emploi '], [7, 'Agriculteurs exploitants /Agricultrices exploitantes'], [8,"	Artisans/Artisanes, commerçants/commerçantes et chefs/cheffes d’entreprise "], [9,'Cadres et professions intellectuelles supérieurs'],[10,'Employés/Employées à temps plein'], [11,'Employés/Employées à temps partiel'], [12,'Auto-entrepreneur/auto-entrepreneuse'], [12, 'Ouvriers/Ouvrières '], [13,'Autre']])
...
class TestCompréhensionBeliefs(Page):
    form_model = 'player'
    form_fields = ['test_Belief1','test_Belief2','test_Belief3','test_Belief4','test_Belief5']
...
class Compréhension_Belief_Gender_Error(Page):
    ...
    def is_displayed(player: Player):
        return player.test_Belief1 != 1 or player.test_Belief2 != 2 or player.test_Belief3 != 0 or player.test_Belief4 != 1 or player.test_Belief5 != 2
...
class Ranking_gender(Page):
    form_model= 'player'
    form_fields = [ 'rank_Jade', 'rank_Gabriel', 'rank_Léo','rank_Louise']
...
class SPSRQ(Page):
    form_model = 'player'
    form_fields = ['SPSRQ_q1', 'SPSRQ_q2', 'SPSRQ_q3', 'SPSRQ_q4', 'SPSRQ_q5','SPSRQ_q6','SPSRQ_q7','SPSRQ_q8','SPSRQ_q9','SPSRQ_q10','SPSRQ_q11','SPSRQ_q12', 'SPSRQ_q13', 'SPSRQ_q14','SPSRQ_q15','SPSRQ_q16','SPSRQ_q17','SPSRQ_q18','SPSRQ_q19','SPSRQ_q20','SPSRQ_q21','SPSRQ_q22']
...
page_sequence = [ Instructions,WaitforSurvey,  Ranking_gender_instructions, TestCompréhensionBeliefs, Compréhension_Belief_Gender_Error, WaitPageforRanking, Ranking_gender,  WaitPageforPart2, RankingTrait, WaitPageforPart3, BFNE, WaitforPart4, SPSRQ, WaitforQuestionnaire, Questionnaire]
