$(document).ready(function () {
    ...
    var rank1stSelect = $('#id_rank1');
    var rank2ndSelect = $('#id_rank2').hide();  // Initially hide
    var rank3rdSelect = $('#id_rank3').hide();  // Initially hide
    var rank4thSelect = $('#id_rank4').hide();  // Initially hide
